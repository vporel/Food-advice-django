	...
	$.fn.mixSlide = function(opt){
		...
		this.each(function(){
			...
			*/
			...
			const isMobile = /Android|Iphone|iPad|iPod|Blaclberry|IEMobile|Opera mini/i.test(navigator.userAgent);
			if(options.responsive && isMobile){
				$obj.addClass('mixSlide-mobile');
			}
